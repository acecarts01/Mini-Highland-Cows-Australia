...
import { ALL_PRODUCTS, AnimalProduct, SITE, CONTACT } from '@/lib/site-config';
...
export default function AnimalDetailPage({ params }: AnimalDetailPageProps) {
  ...
  const animal = ALL_PRODUCTS.find(
    (p) => p.slug === slug || (slug === 'aila-silver-micro-heifer' && p.slug === 'isla-silver-micro-heifer')
  );
  if (!animal) {
    notFound();
  }
  ...
  return (
    <div className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-2 text-xs text-gray-500">
        ...
        <span>/</span>
        <Link
          href={animal.category === 'breeding-foundation' ? '/breeding-foundation' : '/paddock-companions'}
